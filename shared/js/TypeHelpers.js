/*! TypeHelpers v1.1 | (c) Zoltan Hawryluk 2009-11-24 | MIT License | opensource.org/licenses/mit-license.php */
/*
 * Works for
 *   - IE6+ (Windows),
...
var TypeHelpers = new function(){
   ...
   me.getClasses = function(){
      var result = me.hasSmoothing();
      if (result == true) {
         return "hasFontSmoothing-true";
      } else if (result == false) {
         return "hasFontSmoothing-false";
      } else { // result == null
         return "hasFontSmoothing-unknown";
      }
   }
